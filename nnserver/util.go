...
func (self *nnServer) requireMethods(w http.ResponseWriter, r *http.Request, methods []string) bool {
	for i := range(methods) {
...
func (self *nnServer) makeData() map[string]interface{} {
...
func (self *nnServer) decodeJson(w http.ResponseWriter, r *http.Request, req interface{}) (interface{}, error) {
...
func (self *nnServer) okResponse(w http.ResponseWriter) (int, error) {
	w.WriteHeader(http.StatusOK)
	return w.Write([]byte(""))
}


func (self *nnServer) errorResponse(w http.ResponseWriter, code int, message string) (int, error) {
	w.WriteHeader(code)
	return w.Write([]byte(message))
}

func (self *nnServer) getCookie(w http.ResponseWriter, r *http.Request, key string) (*sessions.Session, error)  {
